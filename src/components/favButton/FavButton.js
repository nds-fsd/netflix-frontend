...
const FavButton = (props) => {
  const { setFav, favState } = props;

  return (
    <>
      {favState ? (
        <div className="wrapperFavButton">
          <button className="favButton" onClick={setFav} type="button">
            <svg data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 122.88 117.1" {...props}>
              <title>Delete from MyList</title>
              <path
